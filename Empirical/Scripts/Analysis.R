...
write_csv(res_NARMICE, ".\\Results\\results_NARMICE_Full.csv")
    ...
    ", con="/FILEPATH/BayesianSM/UKBBJAGSmodel.txt")
    ...
    ## And time how long this takes
    start <- Sys.time()
    res <- jags(data=dat_SM, inits=JAGSInits, parameters.to.save=Params, model.file="/FILEPATH/BayesianSM/UKBBJAGSmodel.txt", n.chains=1, n.iter=SM_numiter, n.burnin=SM_numburnin)
